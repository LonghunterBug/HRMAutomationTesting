...
public class ProjectPage {
    ...
    private int TotalProjectCompletedBefore;
    private int TotalProjectInProgressBefore;
    private int TotalProjectNotStartedBefore;
    private int TotalProjectOnHoldBefore;
    ...
    public void editStatus(String title, String progress, String status, String priority) {
        ...
        TotalProjectOnHoldBefore = getTotalProjectsOnHold();
        TotalProjectNotStartedBefore = getTotalProjectsNotStarted();
        searchTitle(title);
        clickViewDetail();
    ...
    public void deleteProject(String title) {
        WebUI.refreshPage();
        TotalProjectNotStartedBefore = getTotalProjectsNotStarted();// Lấy con số trước khi delete project
        searchTitle(title);
        clickDeleteProject();
    ...
    private void handleCompleted(){
        ...
        int expect_TotalProjectsCompleted = TotalProjectCompletedBefore + 1;
        int actual_TotalProjectsNotStarted = getTotalProjectsNotStarted();
        int expect_TotalProjectsNotStarted = TotalProjectNotStartedBefore - 1;
    ...
    private void handleInProgress(){
        ...
        int expect_TotalProjectsInProgress = TotalProjectInProgressBefore + 1;
        int actual_TotalProjectsNotStarted = getTotalProjectsNotStarted();
        int expect_TotalProjectsNotStarted = TotalProjectNotStartedBefore - 1;
    ...
    private void handleOnHold(){
        ...
        int expect_TotalProjectsOnHold = TotalProjectOnHoldBefore + 1;
        int actual_TotalProjectsNotStarted = getTotalProjectsNotStarted();
        int expect_TotalProjectsNotStarted = TotalProjectNotStartedBefore - 1;
